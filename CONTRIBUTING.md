...
**Python 3.10 or newer.** That is the floor the packaging declares and the oldest
version CI runs. The engine needs nothing but PyMuPDF on any of them, and the test suite
nothing the dev extra does not already name: nothing in the tree is 3.11-only.
