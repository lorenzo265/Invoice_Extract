...
# The version the packaging declares. tests/test_repo_hygiene.py imports tomllib, which
# is standard library only from 3.11, and pip refuses the project outright below it.
# Failing here with one sentence beats failing later with a traceback.
