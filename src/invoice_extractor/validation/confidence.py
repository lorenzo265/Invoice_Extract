...
def score(
    extraction: Extraction, field_layout: FieldLayout, findings: Sequence[Finding]
) -> FieldResult:
    ...
    lit = _signals(extraction, field_layout, findings)
    breakdown = {
...
def _signals(
    ...
    return {
        ...
        "in_expected_zone": extraction.zone in field_layout.zones,
