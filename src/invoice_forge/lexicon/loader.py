...
Like profiles, lexicons are shared with the extractor and ship with it, beside the
profiles that reference them: `load_lexicon("de")` resolves there, and only an argument
that looks like a path is read as one.
"""
